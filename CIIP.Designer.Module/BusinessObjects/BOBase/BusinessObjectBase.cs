...
namespace CIIP.Designer
{
    ...
    public abstract class BusinessObjectBase : NameObject, ICategorizedItem, IDocumentProvider
    {
        ...
        [XafDisplayName("系统分类")]
        public abstract SystemCategory SystemCategory
        {
            get;
        }
        ...
        Guid IDocumentProvider.GetDocumentGuid()
        {
            return this.Oid;
        }

        string IDocumentProvider.GetFileName()
        {
            return this.Name + ".cs";
        }
